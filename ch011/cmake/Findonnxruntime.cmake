...
This module provides the following imported targets, if found(若查找成功,该模块会创建如下
导入目标):
...
''onnxruntime_INCLUDE_DIRS''
    Include directories needed to use onnxruntime. (作为使用要求的onnxruntime的头文件目标)
...
''onnxruntime_INCLUDE_DIR''
    The directory containing ''onnxruntime_c_api.h''. (''onnxruntime_c_api_h''所在目录)
''onnxruntime_LIBRARY''
...
''onnxruntime_ROOT''
    The environment variable that points to the root directory of onnxruntime. (指向
    onnxruntime安装根目录的环境变量)
...
# 查找版本号
find_file(onnxruntime_VERSION_FILE VERSION_NUMBER HINTS onnxruntime_ROOT)
# message("onnxruntime_VERSION_FILE = ${onnxruntime_VERSION_FILE}")
...
if(onnxruntime_FOUND)
    ...
    if(WIN32)
        set_target_properties(onnxruntime::onnxruntime PROPERTIES IMPORTED_IMPLIB "${onnxruntime_LIBRARY}")
    else()
